  ...
  return (
    <div className="min-h-screen bg-[#FFFFFF] flex flex-col justify-center items-center py-14 px-4 sm:px-6 lg:px-8">
      <div className="flex w-full justify-start mb-8 pl-8 mt-[-14px]">
        <img src="/image/logo.png" alt="E-MEDATT Logo" className="w-[35px] h-[35px]" />
        <h1 className="font-inter text-2xl font-bold leading-8 text-[#3b54fa] ml-2">E-MEDATT</h1>
      </div>
      ...
      <div className="max-w-7xl w-full mx-auto flex flex-col md:flex-row justify-center items-center rounded-lg  overflow-hidden bg-white">
        ...
        <div className="w-full md:w-1/2 p-8">
          ...
          <p className="mt-2 text-center font-medium font-inter leading-5 text-[#000000]"> Already have an account? <a href="#" className="text-blue-500 font-inter">Login</a></p>
          <div className="mt-6">
            ...
            <div className="space-x-8 flex mt-4 justify-between">
              ...
              >
                ...
                <span className="ml-2 text-[16px]">
                  {formData.firstName} {formData.lastName} Practitioner
                </span>
              </label>
              <label
              ...
              >
                ...
                />
                <span className="ml-2 text-[16px]">
                  {formData.firstName} {formData.lastName}Patient
                </span>
              </label>
            </div>
          </div>
